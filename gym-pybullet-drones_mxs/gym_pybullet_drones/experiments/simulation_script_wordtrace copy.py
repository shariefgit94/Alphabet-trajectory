...
def run_simulation(
    ...
    for i in range(simulation_length):
        ...
        if i < hover_time:
            ...
            idx = i - hover_time
            obs[0][0] -= all_x_target[idx]
            obs[0][1] -= all_y_target[idx]  # y_target will be 0 for all points
            obs[0][2] -= all_z_target[idx]
            target_pos = [all_x_target[idx], all_y_target[idx], all_z_target[idx]]
